...
DST Group thực hiện thiết kế hệ thống nhận diện thương hiệu, các ấn phẩm quảng cáo, bộ tài liệu sales kit giới thiệu dịch vụ và xây dựng các chiến dịch truyền thông đa kênh tối ưu hình ảnh thương hiệu.`, 
  ...
  { 
    ...
    summary: 'Thiết kế bộ nhận diện thương hiệu độc bản, sáng tạo ấn phẩm thực đơn tinh tế và triển khai chiến dịch quảng cáo đa kênh tiếp cận khách hàng mục tiêu.',
    details: `1. THƯƠNG HIỆU:
Cana Beer Club & Brewery là tổ hợp bia thủ công thượng hạng kết hợp không gian âm nhạc sôi động bậc nhất tại trung tâm du lịch Hạ Long. Nơi đây mang đến hành trình trải nghiệm ẩm thực đa giác quan đầy sảng khoái cho thực khách trong và ngoài nước.

2. CHIẾN LƯỢC PHÁT TRIỂN & GIẢI PHÁP:
DST Group đã đồng hành toàn diện trong việc:
- Sáng tạo phong cách trực quan sống động và chuẩn hóa nhận diện hệ thống biển bảng quảng cáo ngoài trời thu hút ánh nhìn.
- Thiết kế bộ menu ẩm thực tinh tế, gia tăng tỷ lệ gọi món của khách hàng.
- Vận hành, biên tập nội dung fanpage truyền thông tích hợp hình ảnh trực quan và chạy các chiến dịch quảng cáo định hướng (targeting ADS) tối ưu hóa doanh thu từ tệp khách hàng địa phương và khách du lịch.`, 
...
DST Group đồng hành thiết kế hồ sơ năng lực (company profile), bộ tài liệu giới thiệu năng lực thi công, catalogue sản phẩm nội thất và chuẩn hóa hình ảnh truyền thông thương hiệu.`, 
  ...
  { 
    ...
    summary: 'Đột phá nhận diện thương hiệu nghỉ dưỡng cao cấp, thiết kế logo chuẩn 5 sao và phát triển website đặt phòng trực tuyến chuyên nghiệp.',
    details: `1. THƯƠNG HIỆU:
Sea Angel Hotel là biểu tượng nghỉ dưỡng cao cấp tọa lạc tại vị trí độc tôn ven vịnh Hạ Long. Sở hữu không gian kiến trúc sang trọng kết hợp nét tinh khôi của biển cả, Sea Angel đòi hỏi một ngôn ngữ thiết kế đồng bộ mang tầm vóc tiêu chuẩn 5 sao quốc tế.

2. CHIẾN LƯỢC PHÁT TRIỂN & GIẢI PHÁP:
DST Group kiến tạo giá trị thương hiệu thông qua giải pháp đồng bộ:
- Sáng tạo Logo nghệ thuật, xây dựng cẩm nang thương hiệu (Brand Guidelines) chuẩn hóa.
- Định hình câu chuyện thương hiệu truyền cảm hứng và thiết lập ngôn ngữ truyền thông cốt lõi.
- Thiết kế bộ ấn phẩm lưu trú độc bản nâng tầm trải nghiệm (thẻ phòng thông minh, thẻ hành lý da, thực đơn Room Service cao cấp).
- Phát triển giao diện website cao cấp tối ưu trải nghiệm người dùng (UX/UI), tích hợp hệ thống đặt phòng và tổ chức tiệc cưới trực tuyến tiện lợi.

3. GIÁ TRỊ MANG LẠI:
Hình ảnh nhất quán giúp nâng cao uy tín thương hiệu vượt trội, tối ưu hóa tỷ lệ chuyển đổi đặt phòng trực tiếp và tạo ấn tượng đẳng cấp vững bền trong lòng du khách.`, 
      ...
      <section className="section interactive-pricing-section">
        <div className="container">
          <div className="section-head text-center" style={{ marginBottom: '40px' }}>
            ...
            <p className="pricing-intro-desc" style={{ color: 'var(--muted)', fontSize: '15.5px', marginTop: '12px', marginLeft: 'auto', marginRight: 'auto' }}>Tra cứu báo giá các hạng mục marketing, quay dựng video và quảng cáo chi tiết cho Nhà hàng, Khách sạn, Cafe và Bar Club.</p>
          </div>
